    ...
    <div className="canvas" style={{backgroundColor: state.background.colorSelected?state.background.colorSelected:"#ebeef4"}}>
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 200 200">
        ...
        }
        {
          ...
          {state.eyes.children.pupil.typeSelected && <use xlinkHref={`#${state.eyes.children.pupil.typeSelected}`} style={state.eyes.children.pupil.typeSelected==='pupil-2' ? {stroke:"none", fill:`${state.eyes.colorSelected?state.eyes.colorSelected:'#000000'}`}:{fill:"none", stroke:`${state.eyes.colorSelected?state.eyes.colorSelected:'#000000'}`}} />}
          {state.eyes.children.pupil.typeSelected && <use xlinkHref={`#${state.eyes.children.pupil.typeSelected}`} style={state.eyes.children.pupil.typeSelected==='pupil-2' ? {stroke:"none", fill:`${state.eyes.colorSelected?state.eyes.colorSelected:'#000000'}`, transformOrigin: "center center", transform:"scaleX(-1)"}:{fill:"none", stroke:`${state.eyes.colorSelected?state.eyes.colorSelected:'#000000'}`, transformOrigin: "center center", transform:"scaleX(-1)"}} />}
