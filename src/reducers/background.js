...
export const palettes = [
  ...
  ['#C63E40', '#EC8677', '#E27C6D', '#D25D60', '#7A0507', '#FFE6E2'],
  ['#476A6F', '#E4998D', '#E58D80', '#D36A5A', '#A64D0E', '#FFBC8C'],
  ['#FFD467', '#E2A68C', '#E19A82', '#CF8167', '#AC4A2A', '#CD5A75'],
  ...
  ['#8CB9BE', '#FCCFC5', '#FCC6BB', '#FCA390', '#E05849', '#E05849'],
  ['#5372A0', '#FFD8CA', '#FFCBB9', '#F38F72', '#DC4F2C', '#EC9192'],
